class CandlekeepCli < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/CandleKeepAgents/homebrew-candlekeep/releases/download/v0.7.0/ck-aarch64-apple-darwin.tar.gz"
      sha256 "db1e24b422a1dd13c70acf30d5e03707ef0552c84e4c570436a398cf9e4e6ee3"
    end
    on_intel do
      url "https://github.com/CandleKeepAgents/homebrew-candlekeep/releases/download/v0.7.0/ck-x86_64-apple-darwin.tar.gz"
